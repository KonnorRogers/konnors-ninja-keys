import{a as u,b as S,c as M,d as $}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-VL3SMF4I.js";import{a as g,b as f,c as b,e as w,f as v,g as y,h as x,i as c,j as z}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-YR3JGFUG.js";import{a as R}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-AYSUWVOO.js";import"/konnors-ninja-keys/bridgetown/static/chunks/chunk-IGCEWXQR.js";import{a as m,d as h}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-YB7THYSR.js";import{d}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-HGOD5HCG.js";var H=m`
:host {
...
`;function T(a,e=" "){let t=[];for(let[i,s]of Object.entries(a))s&&t.push(i);return t.join(e)}var L="Show source code",n=class extends g{constructor(){super(),this.sandboxSettings="",this.summary=L,this.language="html",this.previewMode="iframe",this.resizing=!1,this.disableHighlight=!1,this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1,this.lineNumberStart=1,this.code="",this.previewHtml="",this.open=!1,this.resizePosition=100,this.highlighter=y(),this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.previewHtmlDebounce=c(()=>this.handleMutation("preview-html"),20),this.codeDebounce=c(()=>this.handleMutation("code"),20),this.wrap="soft",this.unescapeBehavior="last",this.scriptScope="document"}resetIframeCodeMutationObserver(){this.previewHtmlMutationObserver&&this.previewHtmlMutationObserver.disconnect(),this.previewHtmlMutationObserver=new MutationObserver((...t)=>this.previewHtmlDebounce());let e=this.findSlot("preview-html")?.assignedElements({flatten:!0})||[];for(let t of e)this.previewHtmlMutationObserver.observe(t,this.__mutationObserverConfig)}resetCodeMutationObserver(){this.codeMutationObserver&&this.codeMutationObserver.disconnect(),this.codeMutationObserver=new MutationObserver((...t)=>this.codeDebounce());let e=this.findSlot("code")?.assignedElements({flatten:!0})||[];for(let t of e)this.codeMutationObserver.observe(t,this.__mutationObserverConfig)}handleMutation(e){if(e==="preview-html"){this.handleTemplate({target:this.findSlot("preview-html")});return}if(e==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(e){return this.shadowRoot?.querySelector(`slot[name='${e}']`)}handleTemplate(e){let t=e.target;if(t==null)return;let i=t.getAttribute("name");if(["preview-html","code"].includes(i||"")===!1)return;let s="type"in e&&e.type==="slotchange",r=t.assignedElements({flatten:!0}),o=w(v(...r).trim());if(i==="preview-html"){s&&this.resetIframeCodeMutationObserver(),this.previewHtml=o,this.requestUpdate("previewHtml");return}if(i==="code"){s&&this.resetCodeMutationObserver(),this.code=o,this.requestUpdate("code");return}}updateIframeContent(){let e=this.previewHtml||this.code,t=this.shadowRoot?.querySelector("iframe");if(!t)return;let i=`
    ...
    `}get panelResizer(){return this.shadowRoot?.querySelector("[part~='panel-resizer']")}handleDrag(e){e.cancelable&&e.preventDefault();let t=this.shadowRoot?.querySelector("iframe");t&&(t.style.pointerEvents="none"),this.resizing=!0;let s=(e.currentTarget?.offsetWidth||0)/2;S(this,{onMove:(r,o)=>{let l=r+s;this.resizePosition=u(0,this.pixelsToPercentage(l),100),this.updateResizePosition(),this.resizing=!0},onStop:()=>{let r=this.shadowRoot?.querySelector("iframe");r&&(r.style.pointerEvents="auto"),this.resizing=!1},initialEvent:e})}updateResizePosition(e=this.resizePosition){let t=e;if(t!=null){let i=100-t;this.style.setProperty("--start-panel-width",`clamp(100px, ${t}%, 100%)`),this.style.setProperty("--end-panel-width",`${i}%`)}}handleResizerKeydown(e){if(["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key)){let t=this.resizePosition,i=(e.shiftKey?10:1)*1;e.preventDefault(),e.key==="ArrowLeft"&&(t-=i),e.key==="ArrowRight"&&(t+=i),e.key==="Home"&&(t=100),e.key==="End"&&(t=0),this.resizePosition=u(0,t,100)}}pixelsToPercentage(e){return e/this.cachedWidth*100}};d(n,"baseName","light-preview"),d(n,"dependencies",{"light-disclosure":$,"light-code":z}),d(n,"styles",[f,b,H]),d(n,"properties",{summary:{},sandboxSettings:{reflect:!0,attribute:"sandbox-settings"},previewMode:{reflect:!0,attribute:"preview-mode"},disableHighlight:{type:Boolean,attribute:"disable-highlight"},open:{reflect:!0,type:Boolean},resizePosition:{reflect:!0,type:Number,attribute:"resize-position"},resizing:{reflect:!0,type:Boolean},language:{reflect:!0},unescapeBehavior:{attribute:"unescape-behavior",reflect:!0},disableLineNumbers:{type:Boolean,reflect:!0,attribute:"disable-line-numbers"},highlightLines:{attribute:"highlight-lines"},insertedLines:{attribute:"inserted-lines"},deletedLines:{attribute:"deleted-lines"},lineNumberStart:{type:Number,attribute:"line-number-start"},scriptScope:{attribute:"script-scope"},wrap:{reflect:!0},code:{},previewHtml:{attribute:"preview-html"},highlighter:{attribute:!1,state:!0}});function C(a,e,t,i){return a.substring(0,e)+i+a.substring(t)}function D(a,e){let t=[...a.matchAll(e)],i=t[t.length-1];if(!i||i.index==null)return a;let{index:s}=i,r=s,o=s+i[0].length,l="</"+i[1]+">";return C(a,r,o,l)}n.define();var ie=n;export{ie as default};
//# sourceMappingURL=/konnors-ninja-keys/bridgetown/static/chunks/light-preview-register-EELUNIZM.js.map
