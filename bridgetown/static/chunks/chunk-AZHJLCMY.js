import{a as j,b as G,c as pe,d as ae,f as ge}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-B7IHSDBC.js";import{d as R}from"/konnors-ninja-keys/bridgetown/static/chunks/chunk-HGOD5HCG.js";var de={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},he=e=>(...t)=>({_$litDirective$:e,values:t}),Y=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,r){this._$Ct=t,this._$AM=n,this._$Ci=r}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}};var W=class extends Y{constructor(t){if(super(t),this.et=ae,t.type!==de.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===ae||t==null)return this.ft=void 0,this.et=t;if(t===pe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let n=[t];return n.raw=n,this.ft={_$litType$:this.constructor.resultType,strings:n,values:[]}}};W.directiveName="unsafeHTML",W.resultType=1;var oe=he(W);function V(e){var t;return t=class extends e{static define(r,a,o){r||(r=this.baseName),a||(a=this);let i=window.customElements;this.__registry instanceof CustomElementRegistry&&(i=this.__registry);let l=!!i.get(r);l&&this.warnOnExistingElement&&console.warn(`${r} has already been registered.`),!l&&a&&i.define(r,class extends a{},o)}},R(t,"baseName",""),R(t,"warnOnExistingElement",!1),t}var ie=class extends V(HTMLElement){};var fe=new WeakMap;function Oe(e,t){let n=t;for(;n;){if(fe.get(n)===e)return!0;n=Object.getPrototypeOf(n)}return!1}function q(e){return t=>{if(Oe(e,t))return t;let n=e(t);return fe.set(n,e),n}}var J=!!ShadowRoot.prototype.createElement,De=e=>{var t;return t=class extends e{static get scopedElements(){return{}}static get shadowRootOptions(){return this.__shadowRootOptions||{mode:"open"}}static set shadowRootOptions(r){this.__shadowRootOptions=r}constructor(...r){super(...r),this.renderOptions=this.renderOptions||void 0}get registry(){return this.constructor.__registry}set registry(r){let a=this.constructor;a.__registry=r}createRenderRoot(){let r=this.constructor,{scopedElements:a,shadowRootOptions:o}=r;if(!this.registry||this.registry===r.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,"__registry")){this.registry=J?new CustomElementRegistry:customElements;for(let[c,s]of Object.entries(a))this.defineScopedElement(c,s)}let l={mode:"open",...o,customElements:this.registry},p=this.attachShadow(l);return J&&(this.renderOptions.creationScope=p),p instanceof ShadowRoot&&this.adoptStyles(p),p}createScopedElement(r){return(J?this.shadowRoot:document).createElement(r)}adoptStyles(r){}defineScopedElement(r,a){let o=this.registry.get(r);return o&&J===!1&&o!==a&&console.error([`You are trying to re-register the "${r}" custom element with a different class via ScopedElementsMixin.`,"This is only possible with a CustomElementRegistry.","Your browser does not support this feature so you will need to load a polyfill for it.",'Load "@webcomponents/scoped-custom-element-registry" before you register ANY web component to the global customElements registry.','e.g. add "<script src="/node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js"><\/script>" as your first script tag.',"For more details you can visit https://open-wc.org/docs/development/scoped-elements/"].join(`
`)),o?this.registry.get(r):this.registry.define(r,a)}},R(t,"__registry",window.customElements),t},ze=q(De);var Ge=e=>class extends e{static get shadowRootOptions(){return this.__shadowRootOptions||{mode:"open"}}static set shadowRootOptions(n){this.__shadowRootOptions=n}get shadowRootOptions(){return this.constructor.shadowRootOptions}createRenderRoot(){return this.shadowRoot??this.attachShadow(this.shadowRootOptions||{mode:"open"})}connectedCallback(){typeof super.connectedCallback=="function"&&super.connectedCallback(),this.renderRoot==null&&(this.renderRoot=this.createRenderRoot())}},He=q(Ge);var U=class extends V(ge){constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([t,n])=>{n.define(t)})}};R(U,"dependencies",{});var be=j`
*, *:after, *:before {
...
`;var N=class{constructor(){let t=()=>{this.errors=[],this.ranges=[],this.numbers=new Set};this.reset=t,this.reset()}includes(t){if(this.numbers.has(t))return!0;if(this.ranges.length==0)return!1;for(let n of this.ranges){let[r,a]=n;if(t>=r&&t<=a)return!0}return!1}parse(t){return this.reset(),t.includes("{")?t.includes("}")?(t=t.split(/{/)[1],t?(t=t.split(/}/)[0],t.split(/,\s*/).forEach(n=>{let[r,a]=n.split(/-/),o=Number(r),i=Number(a);if(!(o==null||isNaN(o))){if(i==null||isNaN(i)){this.numbers.add(o);return}this.ranges.push([o,i])}}),this):(this.errors.push(new Error("Invalid string provided for range.")),this)):(this.errors.push(new Error("Unable to parse range. No `}` found.")),this):(this.errors.push(new Error("Unable to parse range. No `{` found.")),this)}};function Be(e){let{highlightLinesRange:t,insertedLinesRange:n,deletedLinesRange:r}=e;return function(a){let o=1;for(let i of a.tokens)typeof i!="string"&&(t.includes(o)&&(i.type+=" line-highlight"),n.includes(o)&&(i.type+=" inserted"),r.includes(o)&&(i.type+=" deleted"),i.type.includes("light-line")&&o++)}}function Ce(){return function(e){let t=["inserted","line-highlight","deleted"];e.type.includes("light-line")&&(e.attributes.part="line",t.forEach(n=>{e.type.includes(n)&&(n==="line-highlight"&&(n="highlight"),e.attributes.part+=" line-"+n)})),e.type.includes("light-gutter-cell")&&(e.attributes.part="gutter-cell",t.forEach(n=>{e.type.includes("gutter-cell-"+n)&&(n==="line-highlight"&&(n="highlight"),e.attributes.part+=" gutter-cell-"+n)}))}}var I=class extends U{constructor(){super(),this.language="html",this.disableHighlight=!1,this.code="",this.__mutationObserverConfig={childList:!0,subtree:!0,characterData:!0},this.codeDebounce=je(()=>this.handleMutation("code"),20),this.wrap="soft",this.preserveWhitespace=!1,this.highlightLines="",this.insertedLines="",this.deletedLines="",this.disableLineNumbers=!1,this.lineNumberStart=1,this.__resizeObserver=new ResizeObserver(()=>this.__setGutterWidth())}connectedCallback(){super.connectedCallback(),this.__resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.__resizeObserver.unobserve(this)}handleMutation(t){if(t==="code"){this.handleTemplate({target:this.findSlot("code")});return}}findSlot(t){return this.shadowRoot?.querySelector(`slot[name='${t}']`)}handleTemplate(t){let n=t.target;if(n==null)return;let r=n.getAttribute("name");if(["preview-code","code"].includes(r||"")===!1)return;let a=n.assignedElements({flatten:!0}),o=this.unescapeTags(ke(...a));if(this.preserveWhitespace||(o=ve(o.trim())),r==="code"){this.code=o;return}}unescapeTags(t){return t.replaceAll(/&lt;\/([\w\d\.-_]+)>/g,"</$1>")}highlight(t=this.code){let n=[];return n.push($e({lineNumberStart:this.lineNumberStart,disableLineNumbers:this.disableLineNumbers})),n.push(Be({insertedLinesRange:new N().parse(this.insertedLines),deletedLinesRange:new N().parse(this.deletedLines),highlightLinesRange:new N().parse(this.highlightLines)})),A.hooks.add("wrap",Ce()),t=Re(t,A.languages[this.language],this.language,{afterTokenize:n}),t}__setGutterWidth(){let t=this.shadowRoot?.querySelector("[part~='gutter-cell']")?.offsetWidth;t&&this.style.setProperty("--gutter-cell-width",`${t}px`)}render(){let t=this.language,n=G`
    ...
    `;return setTimeout(async()=>{await this.updateComplete,setTimeout(()=>this.__setGutterWidth())}),n}};R(I,"baseName","light-code"),R(I,"styles",[be,Me,me,j`
      [part~="base"] {
        height: 100%;
        position: relative;
	      background: hsl(230, 1%, 98%);
    ...
    `]),R(I,"properties",{summary:{},disableHighlight:{type:Boolean,attribute:"disable-highlight"},preserveWhitespace:{type:Boolean,attribute:"preserveWhitespace"},highlightLines:{attribute:"highlight-lines"},insertedLines:{attribute:"inserted-lines"},deletedLines:{attribute:"deleted-lines"},disableLineNumbers:{type:Boolean,reflect:!0,attribute:"disable-line-numbers"},lineNumberStart:{type:Number,attribute:"line-number-start"},wrap:{reflect:!0,attribute:"wrap"},language:{},code:{}});export{de as a,he as b,Y as c,U as d,be as e,Rt as f,me as g,ve as h,ke as i,E as j,A as k,Re as l,$e as m,ue as n,Mn as o,je as p,I as q};
...
lit-html/directives/when.js:
   ...
   *)
*/
//# sourceMappingURL=/konnors-ninja-keys/bridgetown/static/chunks/chunk-AZHJLCMY.js.map
